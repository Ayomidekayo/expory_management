...
class InvoiceRepository {
    ...
    */
    async findAll(query) {
        const { page, limit, search, status, currency, shipmentId, fromDate, toDate, datePreset, sortBy, sortOrder, } = query;
        let startDate;
        let endDate;
        ...
        switch (datePreset) {
            ...
            case "THIS_QUARTER": {
                ...
                startDate = new Date(today.getFullYear(), quarter, 1);
                endDate = new Date(today.getFullYear(), quarter + 3, 0, 23, 59, 59, 999);
                break;
            }
            case "THIS_YEAR":
