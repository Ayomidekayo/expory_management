...
/*
=====================================
CONSIGNEE DOCUMENT CARD
=====================================
*/

export default function ConsigneeDocumentsCard({
  consignee,
}: Props) {
...
const uploadUrl =
  `/documents/create?consigneeId=${consignee.id}` +
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Documents uploaded and associated with this consignee.
              </p>
            </div>
        ...
        {documents.length === 0 ? (
          ...
          >
            ...
            <p className="mx-auto mt-2 max-w-md text-sm text-slate-500">
              No documents have been uploaded for this exporter.
              Upload supporting documents to keep the exporter
              records complete.
            </p>
