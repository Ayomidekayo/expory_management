import { Eye, ClipboardList, UserRound } from "lucide-react";
...
export default function ExporterAllocationTable({
  allocations,
}: Props) {
  return (
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-0.5 text-sm text-slate-500">
              View allocations associated with this exporter.
            </p>
          </div>
        </div>
      </CardHeader>
        ...
        {allocations.length === 0 ? (
          <div className="flex min-h-[220px] flex-col items-center justify-center px-6 text-center">
            ...
            <p className="mt-1 text-sm text-slate-500">
              This exporter does not have any allocations yet.
            </p>
          </div>
        ) : (
                  ...
                  >
                    ...
                    <TableCell>
                      <span className="whitespace-nowrap text-sm text-slate-600">
                        {formatService(allocation.serviceType)}
                      </span>
                    </TableCell>
