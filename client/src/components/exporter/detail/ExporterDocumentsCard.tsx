...
/*
=====================================
EXPORTER DOCUMENT CARD
=====================================
*/

export default function ExporterDocumentsCard({
  exporter,
}: Props) {
...
const uploadUrl =
  `/documents/create?exporterId=${exporter.id}` +
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Documents uploaded and associated with this exporter.
              </p>
            </div>
